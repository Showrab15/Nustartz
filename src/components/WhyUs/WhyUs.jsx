    ...
    <>
      ...
      <div className=" mx-auto mt-8 md:mt-11 lg:mt-4">
        <div className="mx-auto grid lg:grid-cols-3 gap-10 lg:gap-32 text-center items-center">
          ...
          <div>
            <div className=" p-5 bg-[#3595FC] mt-11 w-[290px] rounded-[35px] cursor-pointer hover:animate-pulse">
              <img
          ...
          <div>
            <div className=" p-5 w-[290px] mt-8 rounded-[35px] cursor-pointer bg-[#3595FC] hover:animate-pulse">
              <img

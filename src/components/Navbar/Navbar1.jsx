...
// import backgroundImage from '../../assets/navbarBG.png'; // Replace 'your-image.jpg' with your actual image file name
    ...
    return (
        ...
        <div className='my-container '>
          <div className="flex items-center">
            <div>
            <img className="relative right-[200px]" src={Coderwall} alt="" />

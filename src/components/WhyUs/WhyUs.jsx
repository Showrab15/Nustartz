...
const WhyUs = () => {
    return (
        <div className="flex-col flex text-white  bgColor  ">
            <div className="flex mx-auto justify-center   pt-28 ">
                ...
                <div className="mx-auto grid md:grid-cols-3 md:gap-32 gap-10 text-center  items-center">
                    <div>
                        <div className="bg-[#3595FC] w-[290px] p-5 rounded-[35px] cursor-pointer hover:animate-pulse">
                            <img className="w-[80px] h-[74px] flex mx-auto" src={chart} alt="" />
                            <p className="py-9 text-[16px] font-semibold font-serif">As you grow, <br />
                                we adapt. Our solutions <br />
                                scale with your evolving needs.</p>
                        </div>
                        <h4 className="mx-auto text-[32px] font-serif font-semibold text-[#275998]">Scalability</h4>
                    </div>

                    <div>

                        <div className=" p-5 bg-[#03254D] mt-8 w-[290px] rounded-[35px] cursor-pointer hover:animate-pulse">
                            <img className="w-[99px] h-[102px] flex mx-auto" src={light} alt="" />
                            <p className="mt-5 text-[16px] font-semibold font-serif">We thrive on innovation,<br /> delivering cutting-edge <br /> solutions that keep your product <br /> ahead of the curve.</p>
                        </div>
                        <h4 className="mx-auto text-[32px] font-serif font-semibold text-[#275998]">Innovation <br />
                            at Core</h4>
                    ...
                    <div>
                        <div className=" p-5 w-[290px] mt-6 rounded-[35px] cursor-pointer bg-[#6287B1] hover:animate-pulse">
                            <img className="w-[94px] h-[94px] flex mx-auto" src={note} alt="" />
                            <p className="py-7 text-[16px] font-semibold font-serif">Your success is our priority, <br /> and we measure it by your achievements.</p>
                        </div>
                        <h4 className="mx-auto text-[32px] font-serif font-semibold text-[#275998]">Results-Driven  <br /> Approach</h4>
                    </div>
                </div>

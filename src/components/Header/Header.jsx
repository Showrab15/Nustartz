  ...
  return (
    <div>
      <Carousel {...carouselSettings}>
        {/* 1st Carousel */}
        <div className="flex flex-col lg:flex-row items-center">
          <div className="order-2 lg:order-1 px-1 lg:px-0 lg:ml-[80px]">
           ...
           <button className="bg-[#275998] py-5 px-10 rounded-[60px] text-white font-semibold mt-8 flex justify-start">
              Schedule
            </button>
           </Link>
          </div>
